...
Route::middleware(['auth', 'role:admin,fee_collection'])->group(function () {
    ...
    /* Exam Fee */
    Route::get('/dashboard/examFees/view', [FeesController::class, 'examFeeView'])->name('exam.fees.view');
    Route::get('/dashboard/examFees/edit/{id}', [FeesController::class, 'examFeeEdit'])->name('exam.fees.edit');
    Route::post('/dashboard/examFees/update/{id}', [FeesController::class, 'examFeeUpdate'])->name('exam.fees.update');
    Route::get('/dashboard/examFees/delete/{id}', [FeesController::class, 'examFeedestroy'])->name('exam.fees.delete');
});
/* Manage Result Here ######### */
