...
// Admin and General Dashboard
Route::get('/dashboard', [DashboardController::class, 'dashboard'])
    ->middleware(['auth', 'verified'])
    ->name('dashboard');

// Class Management
Route::prefix('dashboard')->middleware(['auth', 'role:admin,result'])->group(function () {
...
// Students Management
Route::prefix('dashboard')->middleware(['auth', 'role:admin,admission,fee_collection'])->group(function () {
...
// Fees Management
Route::prefix('dashboard')->middleware(['auth', 'role:admin,fee_collection'])->group(function () {
