...
Route::prefix('dashboard')->middleware('auth')->group(function () {
    Route::get('/exam/view', [ClassController::class, 'view'])->name('exam.view');
    Route::get('/exam/add', [ClassController::class, 'add'])->name('exam.add');
    Route::post('/exam/store', [ClassController::class, 'store'])->name('exam.store');
});
