...
// exam marks api
Route::get('/getExamResult/{studentId}', [ResultController::class, 'getExamResultsApi']);
// exam name api
Route::get('/getExamName', [ExamController::class, 'getExamNameApi']);
// course api
Route::get('/getCourse/{className}', [CourseController::class, 'getCourseApi']);
// exam fee
Route::post('/student/examFee', [ExamController::class, 'examFeeStore']);
Route::post('/student/getExamFee/{studentId}/{examDate?}', [ExamController::class, 'examFeeGet']);