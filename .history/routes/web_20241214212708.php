...
Route::prefix('dashboard')->middleware('auth')->group(function () {
    Route::get('/exam/view', [ClassController::class, 'view'])->name('class.view');
    Route::get('/exam/add', [ClassController::class, 'add'])->name('class.add');
    Route::post('/exam/store', [ClassController::class, 'store'])->name('class.store');
});
