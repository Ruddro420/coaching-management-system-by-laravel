...
// exam marks api
Route::get('/getExamResult/{studentId}/{classname}', [ExamController::class, 'getExamResultsApi']);
// exam name api
Route::get('/getExamResult/{studentId}/{classname}', [ExamController::class, 'getExamNameApi']);