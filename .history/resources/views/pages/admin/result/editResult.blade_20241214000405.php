                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$data->date}}" placeholder="Set Date" name="date" class="datepicker-default form-control"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Name of notice" name="name" class=" form-control"
                                           type="text" required>
                                    </div>
                                </div>
                               <!--  <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select name="class" class="form-control" required>
                                            ...
                                            <option 
                                            value="{{$item->class}}" {{($data->class=="$item->class")?"selected":""}}>
                                            {{$item->class}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group fallback w-100">
                                            <input value="{{$data->rFile}}" name="rFile" type="file" class="dropify" data-default-file="">
                                        </div>
                                    </div>
                                </div>
