                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bloodGroup" class="form-control" value="{{$data->bloodGroup}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Birth Certificate</label>
                                        <input type="text" name="birthCertificate" class="form-control" value="{{$data->birthCertificate}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Father Name English</label>
                                        <input type="text" name="fatherNameEn" class="form-control" value="{{$data->fatherNameEn}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Father Name Bangla</label>
                                        <input type="text" name="fatherNameBn" class="form-control" value="{{$data->fatherNameBn}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Mother Name English</label>
                                        <input type="text" name="motherNameEn" class="form-control" value="{{$data->motherNameEn}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Mother Name Bangla</label>
                                        <input type="text" name="motherNameBn" class="form-control" value="{{$data->motherNameBn}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Father's Mobile</label>
                                        <input type="text" name="fatherMobile" class="form-control" value="{{$data->fatherMobile}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="villagePreset" class="form-control" value="{{$data->villagePreset}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Post Present</label>
                                        <input type="text" name="postPreset" class="form-control" value="{{$data->postPreset}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Thana Present</label>
                                        <input type="text" name="thanaPreset" class="form-control" value="{{$data->thanaPreset}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">District Present</label>
                                        <input type="text" name="distPreset" class="form-control" value="{{$data->distPreset}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Village Permanent</label>
                                        <input type="text" name="villagePermanent" class="form-control" value="{{$data->villagePermanent}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Post Permanent</label>
                                        <input type="text" name="postPermanent" class="form-control" value="{{$data->postPermanent}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Thana Permanent</label>
                                        <input type="text" name="thanaPermanent" class="form-control" value="{{$data->thanaPermanent}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">District Permanent</label>
                                        <input type="text" name="distPermanent" class="form-control" value="{{$data->distPermanent}}">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
