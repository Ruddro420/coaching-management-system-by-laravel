    ...
    ***********************************-->
    <div id="main-wrapper">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('exam.fees.view')}}">Exam Fees</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('result.view')}}">View Notice</a></li>
                            <li><a href="{{route('result.add')}}">Add Notice</a></li>
                        </ul>
                    </li>
                    <li class="nav-label">Exam</li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="la la-bell-o"></i>
                            <span class="nav-text">Exam & Result</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('exam.view')}}">View Exam</a></li>
                            <li><a href="{{route('exam.add')}}">Add Exam</a></li>
                            <li><a href="{{route('exam.result.add')}}">Add Result</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('expense.view')}}">View Expense</a></li>
                            <li><a href="{{route('expense.add')}}">Add Expense</a></li>
                        </ul>
                    </li>
                    <li class="nav-label">Role Management</li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="la la-bell-o"></i>
                            <span class="nav-text">User Register</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a target="blank" href="{{route('user.view')}}">View Users</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © মেধা বিকাশ শিশু নিকেতন এন্ড কুরআন একাডেমি - 
                    2024-25
                </p>
            </div>
        </div>
