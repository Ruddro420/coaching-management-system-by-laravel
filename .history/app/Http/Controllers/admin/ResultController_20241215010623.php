...
class ResultController extends Controller
{
    ...
    // result api
    public function getResults($studentId, $classname, $terms)
    {
        try {
            // Retrieve the data from the ResultModel
            $data = ResultModel::where('roll', $studentId)
                ->where('class', $classname)
                ->where('examination', $terms)
                ->first();
