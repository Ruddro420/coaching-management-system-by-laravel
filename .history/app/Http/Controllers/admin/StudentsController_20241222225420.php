...
class StudentsController extends Controller
{
    ...
    {
        $data = AdmissionModel::find($id);
        $data->studentNameEn = $request->studentNameEn;
        $data->studentNameBn = $request->studentNameBn;
        $data->motherMobile = $request->motherMobile;
        $data->email = $request->email;
        $data->dob = $request->dob;
        $data->gender = $request->gender;
        $data->bloodGroup = $request->bloodGroup;
        $data->birthCertificate = $request->birthCertificate;
        $data->fatherNameEn = $request->fatherNameEn;
        $data->fatherNameBn = $request->fatherNameBn;
        $data->motherNameEn = $request->motherNameEn;
        $data->motherNameBn = $request->motherNameBn;
        $data->fatherMobile = $request->fatherMobile;
        $data->nid = $request->nid;
        $data->villagePreset = $request->villagePreset;
        $data->postPreset = $request->postPreset;
        $data->thanaPreset = $request->thanaPreset;
        $data->distPreset = $request->distPreset;
        $data->villagePermanent = $request->villagePermanent;
        $data->postPermanent = $request->postPermanent;
        $data->thanaPermanent = $request->thanaPermanent;
        $data->distPermanent = $request->distPermanent;
        $data->thanaPermanent = $request->thanaPermanent;
        $data->thanaPermanent = $request->thanaPermanent;
