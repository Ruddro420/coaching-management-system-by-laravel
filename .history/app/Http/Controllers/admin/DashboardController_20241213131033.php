...
class DashboardController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('pages.admin.dashboard.dashboard', compact('totalStudent', 'totalTeacher', 'totalCourse', 'totalFees', 'classList', 'couseList', 'teacherList','pendingFees','totalAdmissionFees'));
    }
}
