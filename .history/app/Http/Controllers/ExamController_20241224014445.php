...
class ExamController extends Controller
{
    ...
    public function examFeeStore(Request $request)
    {
        ...
        // Create the record
        try {
            $examFee = AdmissionFeeController::create($data);
    ...
    // get exam fee
    public function examFeeGet($studentId,$examDate)
    {
        $data = AdmissionFeeController::where('studentId', $studentId)
            ->where('examDate', $examDate) // Assuming there’s a 'month' column in your table
            ->where('status', 1) // Assuming there’s a 'month' column in your table
            ->get();
