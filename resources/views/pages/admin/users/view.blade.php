                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <<!-- td><img class="" width="35"
                                                    ...
                                                    <td>{{$value->name}}</td>
                                                    <td>{{$value->email}}</td>
                                                    <!-- show this error The payload is invalid. fix that -->
                                                    ...
                                                    <td>
                                                        <a href="{{route('user.edit' ,$value->id)}}" class="btn btn-sm btn-primary"><i
                                                                class="la la-pencil"></i></a>
                                                        <a href="{{route('user.delete' ,$value->id)}}" id="delete" class="btn btn-sm btn-danger"><i
