                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{route('teachers.add')}}" class="btn btn-primary">+ Add new</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$value->jDate}}</td>
                                                <td>
                                                    <a href="{{route('teachers.edit' ,$value->id)}}" class="btn btn-sm btn-primary"><i
                                    ...
                                    <div class="card-header justify-content-end pb-0">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item" href="{{route('teachers.edit' ,$value->id)}}">Edit</a>
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            <div class="profile-photo">
                                                <img src="{{(!empty($value->pImg))?url('admin/teachers/'.$value->pImg): url('admin/images/profile/small/pic3.jpg')}}" width="100%"
                                                    class="img-fluid" alt="">
                                            </div>
