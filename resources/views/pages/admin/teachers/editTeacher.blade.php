            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="edit-Teacher.html">Teachers</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Teacher</a></li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="designation" type="text" class="form-control" value="{{$data->designation}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Department</label>
                                            <select name="dept" class="form-control" value="{{$data->dept}}" disabled>
