...
<head>
    ...
    <title>Coaching/Staff Management System</title>
            ...
            <div
                ...
                <div class="relative flex flex-col md:flex-row">
                    <a href="#_"
                        ...
                        <span class="mx-auto text-xl font-black leading-none text-gray-900 select-none">C.HUB<span
                ...
                <div class="flex flex-wrap items-center sm:-mx-3">
                    <div class="w-full md:w-1/2 md:px-3">
                        <div
                            ...
                            <h2
                                class="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-2xl lg:text-2xl xl:text-6xl">
                                <span class="block xl:inline">Coaching Hub</span>
                                <span class="block text-indigo-600 xl:inline">Management
                                    System.</span>
                            </h2>
                            <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">Coaching Hub
                                is a straightforward and effective Coaching Management System tailored for small
                                coaching centers.
                            </p>
                            <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                                ...
                                <a href="https://github.com/Ruddro420/coaching-management-system-by-laravel"
                        ...
                        <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span
                                    class="text-sm font-bold">✓</span></span> Class Management
                        </li>
                        <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span
                                    class="text-sm font-bold">✓</span></span> Course Management
                        </li>
                        <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span
                                    class="text-sm font-bold">✓</span></span> Teacher Management
                        </li>
                        <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span
                                    class="text-sm font-bold">✓</span></span> Student Management
                        </li>
                        <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span
                                    class="text-sm font-bold">✓</span></span> Staff Management
                        </li>
                        <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span
                                    class="text-sm font-bold">✓</span></span> Student Fee Management
                        </li>
                        <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                            <span
                                class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span
                                    class="text-sm font-bold">✓</span></span> Result/Notice Management
                        </li>
                    </ul>
                </div>
                <!-- End  Content -->
                        ...
                        <div class="w-full lg:max-w-md">
                            ...
                            <ul>
                                <li class="flex items-center py-2 space-x-4 xl:py-3">
                                    ...
                                    <span class="font-medium text-gray-500">User-Friendly Interface</span>
                                </li>
                                <li class="flex items-center py-2 space-x-4 xl:py-3">
                                    ...
                                    <span class="font-medium text-gray-500">Reports and Analytics
                                        Monitoring</span>
                                </li>
                                <li class="flex items-center py-2 space-x-4 xl:py-3">
        ...
        <section class="bg-white">
            <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                ...
                <p class="mt-8 text-base leading-6 text-center text-gray-400">
                    © 2023 Ali Fiad Ruddro. All rights reserved.
                </p>
            </div>
        </section>
